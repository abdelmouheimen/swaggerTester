      ...
      <div style={{ marginBottom }}>
        ...
        >
          <div className="path__message">
            ...
            {isRunning && (
              <div className="path__deleteIcon">
                <HighlightOffIcon onClick={
                  (value) => {
                    console.log(`dmgfdmhgkfdjhgdf ${ob}`);
                    onDeletePath(ob.id)
                  }
                } />
              </div>
            ...
            <Modal.Description>
              ...
              <Table celled padded>
                ...
                <Table.Body>
                  {spec &&
                    spec.parameters &&
                    spec.parameters.map((subSpec, i) => (
                      <Parameter
                        key={i}
                        spec={subSpec}
                        value={testValues[subSpec.name]}
                        onChange={(value) =>
                          this.onParameterTestValueChange(subSpec, value)
                        }
                      />
                    ))}
                  {spec &&
                    ...
                    spec.requestBody.content["application/json"] && (
                      <Parameter
                        body={true}
                        spec={spec.requestBody.content["application/json"]}
                        value={
                          testValues[
                          spec.requestBody.content["application/json"].name
                          ]
                        }
                        onChange={(value) =>
                          this.onParameterTestValueChange(
                            spec.requestBody.content["application/json"],
                            value
                          )
                        }
              ...
              <Assertions
                ...
                onChange={(assertions) => onAssertionsChange(assertions)}
              />
              ...
              <Extractions
                ...
                onChange={(extractions) => onExtractionsChange(extractions)}
              />
            </Modal.Description>
          </Modal.Content>
        </Modal>
